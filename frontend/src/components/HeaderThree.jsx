            ...
            <div className='logo'>
              <Link to='/' className='link text-white d-flex align-items-center'>
                <svg width="150" height="38" viewBox="0 0 150 38" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ verticalAlign: 'middle' }}>
                  <path d="M14 2L3 21H15L11 36L27 14H16L22 2H14Z" fill="url(#logoGrad3)" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                  ...
                  <defs>
                    <linearGradient id="logoGrad3" x1="3" y1="2" x2="27" y2="36" gradientUnits="userSpaceOnUse">
